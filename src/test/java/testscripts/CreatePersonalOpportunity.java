...
//		Thread.sleep(6000);
		...
		vehicleform.enterVIN().sendKeys(Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE);
		vehicleform.enterVIN().sendKeys(properties.getString("VIN"), Keys.ENTER);

		vehicleform.enterYear().sendKeys(Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE);
