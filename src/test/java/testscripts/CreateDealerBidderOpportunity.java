...
public class CreateDealerBidderOpportunity extends CreateDealerAcc {

	@Test
	void createDealerBidderOpportunityTest() throws InterruptedException, IOException {
...
//		Thread.sleep(2000);
		...
		registrationDocs.put("Bidder Agreement",
				"C:\\Users\\tvinod\\eclipse-workspace\\BJAC-Dynamic-CRM-master\\Automation_Photos_Docs\\Bidder Agreement.jpg");
		registrationDocs.put("Square Payment Receipt",
				"C:\\Users\\tvinod\\eclipse-workspace\\BJAC-Dynamic-CRM-master\\Automation_Photos_Docs\\Square Payment Receipt.jpg");
		registrationDocs.put("Authorization to Bid",
				"C:\\Users\\tvinod\\eclipse-workspace\\BJAC-Dynamic-CRM-master\\Automation_Photos_Docs\\Authorization to Bid.jpg");
		registrationDocs.put("Funds Letter",
				"C:\\Users\\tvinod\\eclipse-workspace\\BJAC-Dynamic-CRM-master\\Automation_Photos_Docs\\Funds Letter.png");
		registrationDocs.put("Additional Funds Letter",
				"C:\\Users\\tvinod\\eclipse-workspace\\BJAC-Dynamic-CRM-master\\Automation_Photos_Docs\\Additional Funds Letter.jpg");
		registrationDocs.put("Bidding Collateral",
				"C:\\Users\\tvinod\\eclipse-workspace\\BJAC-Dynamic-CRM-master\\Automation_Photos_Docs\\Bidding Collateral.png");
		registrationDocs.put("OFAC", 
				"C:\\Users\\tvinod\\eclipse-workspace\\BJAC-Dynamic-CRM-master\\Automation_Photos_Docs\\OFAC.jpg");
		...
		captureScreenshot("createDealerBidderOpportunityTest");
		Thread.sleep(3000);
	}
